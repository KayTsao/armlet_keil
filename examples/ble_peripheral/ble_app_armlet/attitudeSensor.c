...
void initAlgoParam(AttitudeSensor *sensor)
{
	...
	sensor->Mag_Scale[0] = 1.0f;//1.062f;
	sensor->Mag_Scale[1] = 1.0f;//1.0367f;
	sensor->Mag_Scale[2] = 1.0f;//1.0f; 
	sensor->Mag_Bias[0] = 0.0f;//-0.034f; 
	sensor->Mag_Bias[1] = 0.0f;//0.0595f; 
	sensor->Mag_Bias[2] = 0.0f;//0.0f; 
/*	
