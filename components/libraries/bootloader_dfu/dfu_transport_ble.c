...
#ifdef IQIYI_HANDLE
	#define DEVICE_NAME                      "IQIYI-Handle-Dfu"                                               /**< Name of device. Will be included in the advertising data. */
#else
	#define DEVICE_NAME                      "IQIYI-Armlet-Dfu"                                               /**< Name of device. Will be included in the advertising data. */
#endif
